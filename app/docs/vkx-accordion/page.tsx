  ...
  return (
    <div className="flex w-full flex-col gap-y-10 pb-8">
      <div>
        ...
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Trong trường hợp này, chỉ cho phép mở một accordion item tại một thời điểm. Khi bạn mở một item mới,
            item đang mở sẽ tự động đóng lại. Điều này được thực hiện bằng cách sử dụng prop <code>selectionMode=&quot;single&quot;</code>.
          </p>
          <p className="mt-2 text-sm text-gray-500">
            Thích hợp sử dụng khi bạn muốn người dùng tập trung vào một nội dung tại một thời điểm.
          </p>
        </div>
      ...
      <div>
        ...
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Cho phép mở nhiều accordion item cùng một lúc. Người dùng có thể xem nhiều nội dung đồng thời.
            Sử dụng prop <code>selectionMode=&quot;multiple&quot;</code> để kích hoạt tính năng này.
          </p>
          <p className="mt-2 text-sm text-gray-500">
            Phù hợp cho các trường hợp người dùng cần so sánh hoặc xem nhiều thông tin cùng lúc.
          </p>
        </div>
        <div className="mx-auto flex pt-6">
          <VkxAccordion
      ...
      <div>
        ...
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Thêm thông tin phụ đề (subtitle) cho mỗi accordion item để cung cấp thêm ngữ cảnh hoặc mô tả ngắn.
            Phụ đề được hiển thị dưới tiêu đề chính và giúp người dùng hiểu rõ hơn về nội dung bên trong.
          </p>
        </div>
        <div className="mx-auto flex pt-6">
          <VkxAccordion
      ...
      <div>
        ...
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Có thể cấu hình accordion để mặc định mở một hoặc nhiều item khi trang được tải.
            Sử dụng prop <code>defaultExpandedKeys</code> và truyền vào một Set chứa các key của các item cần mở.
          </p>
          <p className="mt-2 text-sm text-gray-500">
            Hữu ích khi bạn muốn hiển thị một số nội dung quan trọng ngay từ đầu.
          </p>
        </div>
        <div className="mx-auto flex pt-6">
          <VkxAccordion
      ...
      <div>
        ...
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Vô hiệu hóa khả năng mở/đóng của một số accordion item cụ thể.
            Sử dụng prop <code>disabledKeys</code> và truyền vào một Set chứa các key của các item cần vô hiệu hóa.
          </p>
          <p className="mt-2 text-sm text-gray-500">
            Thích hợp khi một số nội dung tạm thời không khả dụng hoặc không cho phép truy cập.
          </p>
        </div>
        <div className="mx-auto flex pt-6">
          <VkxAccordion
      ...
      <div>
        <h1 className="text-xl font-medium text-black dark:text-white">Trường hợp 6: Điều khiển sự kiện chọn</h1>
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Theo dõi và xử lý sự kiện khi người dùng mở/đóng các accordion item.
            Sử dụng prop <code>onSelectionChange</code> để nhận callback mỗi khi có thay đổi.
          </p>
          <p className="mt-2 text-sm text-gray-500">
            Cho phép bạn thực hiện các hành động tùy chỉnh như theo dõi hành vi người dùng hoặc đồng bộ hóa trạng thái.
          </p>
        </div>
        <div className="mx-auto flex pt-6">
          <VkxAccordion
      ...
      <div>
        <h1 className="text-xl font-medium text-black dark:text-white">Trường hợp 7: Tùy chỉnh giao diện với HTML</h1>
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            Tùy chỉnh giao diện của accordion items bằng cách sử dụng HTML và các component tùy chỉnh.
            Có thể thêm hình ảnh, biểu tượng, liên kết và các thành phần giao diện khác.
          </p>
          <p className="mt-2 text-sm text-gray-500">
      ...
      <div className="mt-12">
        ...
        <h2 className="text-xl font-medium text-black dark:text-white mt-8 mb-4">VkxAccordion Props</h2>
          ...
          <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-700">
            ...
            <tbody className="bg-white dark:bg-gray-900">
              ...
              <tr>
                ...
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">
                  <code>&quot;light&quot; | &quot;bordered&quot; | &quot;shadow&quot;</code>
                </td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">
                  <code>&quot;light&quot;</code>
                </td>
              ...
              <tr>
                ...
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">
                  Xác định xem accordion có hiển thị ở chế độ nhỏ gọn (compact) hay không. Khi được bật, các item sẽ chiếm ít không gian hơn.
                </td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">
                ...
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">
                  Xác định các item đang được chọn trong accordion. 
                  Giá trị là một Set chứa các key của các item được chọn. 
                  Thích hợp khi bạn muốn kiểm soát trạng thái chọn từ bên ngoài.
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <h2 className="text-xl font-medium text-black dark:text-white mt-8 mb-4">VkxAccordionItem Props</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-700">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Thuộc tính</th>
                <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Kiểu dữ liệu</th>
                <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Bắt buộc</th>
                <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Mô tả</th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-gray-900">
